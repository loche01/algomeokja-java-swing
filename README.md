...
- 캘린더 화면에서 오늘 저장한 운동 기록의 운동명, 소모 칼로리, 저장 시간을 확인할 수 있습니다.
...
- 캘린더 화면에서 오늘 저장한 운동 기록을 표시하도록 개선했습니다.
...
현재 기본 실행, 관리자 로그인, 사용자 회원가입, 주요 화면 진입 및 운동 기록 저장/확인 흐름은 가능하지만, 포트폴리오 완성도를 높이기 위해 다음 개선이 필요합니다.
...
### 3. README와 실제 실행 흐름 일치 여부 점검

기능 복구가 진행되면서 README 설명과 실제 앱 화면 흐름이 달라질 수 있습니다.
캡처 이미지, 실행 순서, 알려진 문제 목록은 기능 수정 후 계속 점검해야 합니다.
